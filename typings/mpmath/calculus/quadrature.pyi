...
class QuadratureRule:
    ...
    def calc_nodes(self, degree, prec, verbose=...):
        r"""
    ...
    def get_nodes(self, a, b, degree, prec, verbose=...): # -> list[tuple[Any, Any]] | list[Any]:
        """
    ...
    def transform_nodes(self, nodes, a, b, verbose=...): # -> list[tuple[Any, Any]] | list[Any]:
        r"""
    ...
    def guess_degree(self, prec): # -> int:
        """
    ...
    def summation(self, f, points, prec, epsilon, max_degree, verbose=...): # -> tuple[Any, Any]:
        """
    ...
    def sum_next(self, f, nodes, degree, prec, previous, verbose=...):
        r"""
...
class TanhSinh(QuadratureRule):
    ...
    * http://users.cs.dal.ca/~jborwein/tanh-sinh.pdf
    ...
    def calc_nodes(self, degree, prec, verbose=...): # -> list[Any]:
        r"""
...
class GaussLegendre(QuadratureRule):
    ...
    """
    def calc_nodes(self, degree, prec, verbose=...): # -> list[tuple[Any, Any]] | list[Any]:
        r"""
...
class QuadratureMethods:
    ...
    def quad(ctx, f, *points, **kwargs): # -> tuple[Any, Any]:
        r"""
    ...
    def quadts(ctx, *args, **kwargs): # -> tuple[Any, Any]:
        """
    ...
    def quadgl(ctx, *args, **kwargs): # -> tuple[Any, Any]:
        """
    ...
    def quadosc(ctx, f, interval, omega=..., period=..., zeros=...):
        r"""
        Calculates
    ...
    def quadsubdiv(ctx, f, interval, tol=..., maxintervals=..., **kwargs): # -> tuple[Any, Any]:
        """
