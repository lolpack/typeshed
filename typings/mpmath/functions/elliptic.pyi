...
@defun_wrapped
def qfrom(ctx, q=..., m=..., k=..., tau=..., qbar=...): # -> Any | None:
    r"""
...
@defun_wrapped
def qbarfrom(ctx, q=..., m=..., k=..., tau=..., qbar=...): # -> Any | None:
    r"""
...
@defun_wrapped
def taufrom(ctx, q=..., m=..., k=..., tau=..., qbar=...): # -> None:
    r"""
...
@defun_wrapped
def kfrom(ctx, q=..., m=..., k=..., tau=..., qbar=...): # -> Literal[1]:
    r"""
...
jacobi_spec = ...
@defun
def ellipfun(ctx, kind, u=..., m=..., q=..., k=..., tau=...): # -> Callable[..., Any]:
    ...

@defun_wrapped
def kleinj(ctx, tau=..., **kwargs):
    r"""
...
@defun
def elliprj(ctx, x, y, z, p, integration=...):
    r"""
...
@defun_wrapped
def ellippi(ctx, *args): # -> Literal[0]:
    r"""
